...
final class SplashViewController: KYViewController {
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		NotificationCenter.default.post(name: .didStartDataAction, object: nil, userInfo: ["isSuccess": true, "data": "network"])
		let didStartDataAction = DidStartDataAction()
		NotificationCenter.default.post(name: .didStartDictionaryAction, object: nil, userInfo: ["isSuccess": false, "didStartDataAction": didStartDataAction.dictionary])
	}
